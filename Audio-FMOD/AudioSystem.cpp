...
void AudioSystem::LoadBanks() {
	...
	mStudio->loadBankFile("Audio/Master.bank", FMOD_STUDIO_LOAD_BANK_NORMAL, &master);
	mStudio->loadBankFile("Audio/Master.strings.bank", FMOD_STUDIO_LOAD_BANK_NORMAL, &strings);
	mStudio->loadBankFile("Audio/Musics.bank", FMOD_STUDIO_LOAD_BANK_NORMAL, &musics);
}
