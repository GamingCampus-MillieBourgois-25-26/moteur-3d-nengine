...
void AudioSystem::LoadBanks() {
	...
	FMOD_RESULT result1 = mStudio->loadBankFile("C:/Users/mpanza/Documents/GitHub/moteur-3d-nengine/Engine/Audio/Master.bank", FMOD_STUDIO_LOAD_BANK_NORMAL, &master);
	if (result1 != FMOD_OK) std::cout << FMOD_ErrorString(result1) << std::endl;

	FMOD_RESULT result2 = mStudio->loadBankFile("C:/Users/mpanza/Documents/GitHub/moteur-3d-nengine/Engine/Audio/Master.strings.bank", FMOD_STUDIO_LOAD_BANK_NORMAL, &strings);
	if (result2 != FMOD_OK) std::cout << FMOD_ErrorString(result2) << std::endl;

	FMOD_RESULT result3 = mStudio->loadBankFile("C:/Users/mpanza/Documents/GitHub/moteur-3d-nengine/Engine/Audio/Musics.bank", FMOD_STUDIO_LOAD_BANK_NORMAL, &musics);
