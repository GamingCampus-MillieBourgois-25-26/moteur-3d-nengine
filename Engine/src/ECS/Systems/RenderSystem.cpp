...
void RenderSystem::Render(Coordinator & coord, Renderer & renderer)
{
    ...
    // mEntities contient toutes les entit�s ayant Transform + MeshRenderer
    ...
    // Ne pas appeler EndFrame ici : l'exécutable (qui gère ImGui) fera la présentation après avoir rendu l'UI.
}